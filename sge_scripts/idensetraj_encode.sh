...
source /net/per610a/export/das11f/plsang/codes/tvmed-framework-edu-v2.0/sge_scripts/edu_lib.sh
...
cd /net/per610a/export/das11f/plsang/codes/tvmed-framework-edu-v2.0
# Log info of current dir 

LD_PRELOAD="/net/per610a/export/das11f/plsang/usr/lib64/libstdc++.so:/net/per610a/export/das11f/plsang/usr/lib64/libgcc_s.so.1" matlab -nodisplay -r "idensetraj_encode('$1', '$2', $3, $4)"
# Log ending time
date
