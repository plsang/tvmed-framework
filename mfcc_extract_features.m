function feat = mfcc_extract_features_2014( filepath, toolbox, start_frame, end_frame)
...
%   Detailed explanation goes here
	...
	tmpdir = '/net/per610a/export/das11f/plsang/tmp';
	...
	if ~exist('start_frame', 'var') && ~exist('end_frame', 'var'),
		...
		cmd = sprintf('%s -i %s -loglevel quiet -y -vn -ac %d -ar 44100 -ab 320k -f wav %s', ffmpeg_bin, filepath, ac_param, tmp_audio_file);
	else
